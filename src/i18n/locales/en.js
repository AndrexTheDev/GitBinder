...
export default {
  ...
  adblock: {
    title: '{app} needs to stop hiding',
    lead: 'An ad blocker is active in this browser, so the interface is unavailable.',
    body: 'GitBinder shows no advertising, but its interface is hidden whenever a content blocker is running. Please allow this page, then continue.',
    step1: 'Open your ad blocker’s menu for this site.',
    step2: 'Turn it off, or add an exception for this address.',
    step3: 'Come back and press “Check again”.',
    checking: 'Checking…',
    hint: 'Nothing was changed and nothing was sent anywhere — this check only looks at the page itself.',
    stillBlocked: 'Still detected. The app stays unavailable until the blocker is off for this page.',
    retry: 'Check again',
    learnMore: 'About GitBinder',
    foot: 'Free, open source, and entirely client-side.',
  },
  errors: {
